       ...
       <div class="row clearfix">
          ...
          <div class="content-side col-lg-10 col-md-12 col-sm-12" style="margin:0 auto">
             <div class="department-detail">
                <div class="inner-box">
                    <div class="image">
                        <img style="border-radius:15px" src="{{asset('uploads/S-25716.webp')}}" alt="" />
                     </div>

                    <div>
                        <h4>Drug-Free Workplace Program at Biopassion Diagnostics</h4>
                        <p>Maintaining a drug-free workplace is essential for ensuring the safety, health, and productivity of your employees. At Biopassion Diagnostics, we offer comprehensive <a href="https://www.biopassiondiagnostics.com/drug-free-workplace">Drug-Free Workplace Programs</a> designed to help organizations create and sustain a safe and efficient work environment. Our programs include drug testing services, educational resources, and support for implementing and maintaining a drug-free policy.</p>
                        ...
                        <h5>Policy Development and Implementation</h5>
                        <p>Developing and implementing a robust drug-free workplace policy is crucial for the success of your program. Our experts at Biopassion Diagnostics work with you to create a comprehensive policy that aligns with legal requirements and industry best practices. We provide guidance on policy communication, employee training, and procedures for handling positive test results.</p>

                        <h5>Employee Education and Training</h5>
                        <p>Education is a key component of maintaining a drug-free workplace. We offer educational resources and training sessions to help employees understand the importance of a drug-free environment. Our programs cover the dangers of drug and alcohol abuse, the impact on workplace safety and productivity, and the details of your company's drug-free policy.</p>
