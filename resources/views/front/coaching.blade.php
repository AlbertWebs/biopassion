             ...
             <div class="department-detail">
                <div class="inner-box">
                    ...
                    <div>
                        ...
                        <h5>Comprehensive Wellness Plans</h5>
                        <p>Biopassion Diagnostics develops comprehensive wellness plans that encompass a wide range of health aspects. Our health coaching includes goal setting, regular progress tracking, and adjustments to ensure continuous improvement. By focusing on holistic health, we help employees achieve a balanced lifestyle that supports both personal and professional success.</p>

                        <h5>Improving Employee Engagement</h5>
                        <p>Engaged employees are more productive and satisfied with their work. Our Employee Health Coaching programs foster a culture of health within the workplace, encouraging employees to take an active role in their wellness journey. Through regular check-ins, educational resources, and supportive coaching, we boost employee engagement and morale.</p>
