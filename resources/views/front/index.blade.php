...
@section('content')
         ...
         <section class="slider-four">
            <div class="main-slider-carousel owl-carousel owl-theme">
               <div class="slide" style="background-image:url('{{('theme/assets/images/main-slider/image-7.html')}})">
                  <div class="auto-container">
                     <!-- Content Column -->
                     <div class="content-column">
                        <div class="inner-column">
                           <div class="title">healthy borns</div>
                           <h2>return tto normal activities</h2>
                           <div class="text">Physiotherapy helps to restore movement and function when someone is affected by injury, illness or disability. It can also help to reduce your risk of injury or illness in the future.</div>
                           <div class="slider-four_oprions d-flex align-items-center flex-wrap">
               ...
               <div class="slide" style="background-image:url('{{('theme/assets/images/main-slider/image-8.jpg')}}')">
                  <div class="auto-container">
                     <!-- Content Column -->
                     <div class="content-column">
                        <div class="inner-column">
               ...
               <div class="slide" style="background-image:url('{{('theme/assets/images/main-slider/image-9.jpg')}}')">
                  <div class="auto-container">
                     <!-- Content Column -->
                     <div class="content-column">
                        <div class="inner-column">
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <div class="doctor-info">
                                 <figure class="thumb"><img src="{{asset('theme/assets/images/resource/author-3.jpg')}}" alt=""></figure>
         ...
         <!-- End News Section -->
         <!-- Sponsors Section -->
         <section class="sponsors-two style-two">
            <div class="auto-container">
               <div class="sponsors-outer">
                  <!-- Sponsors Carousel -->
                  <ul class="sponsors-carousel owl-carousel owl-theme">
                     <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{asset('theme/assets/images/clients/6.png')}}" alt=""></a></figure>
                     </li>
                     <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{asset('theme/assets/images/clients/7.png')}}" alt=""></a></figure>
                     </li>
                     <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{asset('theme/assets/images/clients/8.png')}}" alt=""></a></figure>
                     </li>
                     <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{asset('theme/assets/images/clients/9.png')}}" alt=""></a></figure>
                     </li>
                     <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{asset('theme/assets/images/clients/10.png')}}" alt=""></a></figure>
                     </li>
                     <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{asset('theme/assets/images/clients/6.png')}}" alt=""></a></figure>
                     </li>
